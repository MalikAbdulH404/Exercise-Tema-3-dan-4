...
WebUI.setText(findTestObject('Page_My Account Login/text_input_username'), '')
...
WebUI.verifyElementText(findTestObject('Page_My Account Login/text_error username is required'), 'Error: Username is required.')
